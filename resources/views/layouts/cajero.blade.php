...
<body>
   ...
   <header class="header">
    <div class="header__container container d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('cambiocontraseñacajero') }}" class="sidebar__link">
            ...
            <!-- Replicate the account section in the header -->
            <div class="sidebar__account">
                @if(Auth::user()->imagen)
                    <img src="{{ asset('imagen/' . Auth::user()->imagen) }}" alt="sidebar image" class="sidebar__perfil rounded-circle" style="width: 50px; height: 50px;">
                @else
                    <img src="{{ asset('img/ph.png') }}" alt="sidebar image" class="sidebar__perfil rounded-circle" style="width: 50px; height: 50px;">
                @endif
